      ...
      <div class="w-full relative text-gray-600 focus-within:text-gray-400 bg-mygrey2 rounded-md flex">
         <div class="flex items-center">
            ...
            <input
               ...
               type="search"
               name="p"
               class="xl:w-36 w-full py-2 text-sm pr-10 focus:outline-none focus:text-gray-900 bg-mygrey2 rounded-md"
         ...
         <div class="flex items-center">
            ...
            <input
               ...
               type="search"
               name="q"
               class="xl:w-96 w-full py-2 text-sm pr-10 focus:outline-none focus:text-gray-900 bg-mygrey2 rounded-md"
