<template>
   <select class="myinput" v-model="department_selected" name="" id="" @change="$emit('update:department', department_selected)">
      <option value="" disabled>Departement</option>
      <option v-for="(department, index) in departments" :key="'department_' + index" :value="department.value">{{ department.name }}</option>
   </select>
</template>
...
export default {
   data() {
      return {
         department_selected: "",
         departments: [
            { value: "ETR", name: "ETR - Etranger" },
            { value: "NAT", name: "NAT - National" },
            ...
            { value: "54", name: "54 - Meuthe-et-Moselle" },
            ...
            { value: "65", name: "65 - Hautes Pyrénnées" },
            { value: "66", name: "66 - Pyrénnées-Orientales" },
